...
# suppressMessages(pacman::p_load("DEoptim", "random", "ROI", "pso","GenSA","ROI.plugin.glpk",
#                                 "ROI.plugin.quadprog","ROI.plugin.symphony","foreach","iterators",
#                                 "fGarch","Rglpk","quadprog","corpcor","testthat","nloptr","MASS",
#                                 "robustbase","PerformanceAnalytics","quantmod","highfrequency",
#                                 "LSMRealOptions","RQuantLib","Jdmbs","fOptions","LaplacesDemon",
#                                 "edgar","PortfolioAnalytics","reticulate","LSMonteCarlo","anytime",
#                                 "LSMonteCarlo","BatchGetSymbols","fPortfolio","pbapply","lubridate",
#                                 "HARModel","chron","TTR","future","dplyr","IBrokers","alphavantager",
#                                 "tidyquant","httr","purrr","rvest","quantstrat","tseries",
#                                 "FinancialInstrument","devtools","urca","derivmkts","dplyr","tidyr",
#                                 "data.table","jsonlite","stringr","Rcpp","padr","cronR","shiny",
#                                 "miniUI","shinyFiles","BLModel","BLCOP","portfolioBacktest","corrplot"))
